...
{
    public partial class OderNhanVien : Form
    {
        public OderNhanVien()
        {
            InitializeComponent();
        ...
        private void OderNhanVien_Load(object sender, EventArgs e)
        {
        ...
        CN_NhanVienOrrder a=new CN_NhanVienOrrder();
        ...
        private void btn_order_Click(object sender, EventArgs e)
        {
            ...
            string tendn = "di";
            if (Properties.Settings.Default.taikhoannhanvien != null || Properties.Settings.Default.taikhoannhanvien!="")
            {
                tendn = Properties.Settings.Default.taikhoannhanvien;
            }else
            {
                tendn = "di";
            }
                    ...
                    if (result != null)
                    {
                        ...
                        if (txt_tongtien.Text != "")
                        {
                            ...
                            using (frm_ChonThanhToan ctt = new frm_ChonThanhToan())
                            {
                                ...
                                cmdthanhtoan.Parameters.AddWithValue("@TongTien", double.Parse(txt_tongtien.Text));
        ...
        private void btn_giamgia_Click_1(object sender, EventArgs e)
        {
